...
import com.duoduoweather.android.gson.Forecast;
...
public class WeatherActivity extends AppCompatActivity {
        ...
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Weather.HeWeatherBean anObject = weather.getHeWeather().get(0);
                        if (weather != null && "ok".equals(anObject.getStatus())) {
    ...
    private void showWeatherInfo(Weather weather) {
        Weather.HeWeatherBean.BasicBean basic = weather.getHeWeather().get(0).getBasic();
        Weather.HeWeatherBean.NowBean now = weather.getHeWeather().get(0).getNow();
        ...
        Weather.HeWeatherBean.AqiBean aqi = weather.getHeWeather().get(0).getAqi();
        if (aqi != null) {
            aqiText.setText(aqi.getCity().getAqi());
            pm25Text.setText(aqi.getCity().getPm25());
        }
        Weather.HeWeatherBean.SuggestionBean suggestion = weather.getHeWeather().get(0).getSuggestion();
        String comfort = "舒适度:" + suggestion.getComf().getTxt();
        String carWash = "洗车指数:" + suggestion.getCw().getTxt();
        String sport = "运动建议:" +suggestion.getSport().getTxt();
